...
const Responsive = {
  ...
  updateMobileNavActive() {
    ...
    // Special-case: reels page (/yt-reels → video.html)
    if (path.endsWith('/yt-reels') || path.endsWith('/video.html')) {
      const reelItem = document.querySelector('.mobile-nav__item[href="/yt-reels"]');
      if (reelItem) reelItem.classList.add('active');
    }
  },
