...
// ─── Download & serve Giphy media locally ────────────────────────────────────
const MEDIA_DIR = path.join(__dirname, 'public', 'media', 'giphy');

const GIPHY_IDS = [
  'l0HlNaQ6gWfllqwDO','3oEduQ2rYb6GtPOWk0','26u4lOMA8BwodbbLG','3o7TKSha7HbhXj6mRa',
  '3oEjI6SIIHBdRxXI40','3o85xGocYD8uV5K90U','26gs1dK2P7EzuXW2Y','3og0INyCmHlNylks9e',
  '7MZ5eEl0MxQ2A','1nq5mP2nHlMGI','3o85xnoYEBk0b7vE4w','8t8jrF6YQbSqQ',
  '3o6Zt481isNV1y7Aqk','26gJzVWvMMGMi0xHO','jWcyMSGqMBhJG','dSetNZ0M3OYq0',
  'l0HlUK7B2GMdKZKla','3o7TKM6snABh6iIMvS','3o7TKz5qWX8Pc6d6M0','13aJ2Im0F3XYqA',
  '26FPo47jFGHLTNDMc','l0HlRuVN4l2dR8NBe','3o85xnxCcCjC1p6t6',
];
...
function generateMediaLibrary(prefix, count) {
  const lib = [];
...
const EMOJI_DATA = {
    ...
    "Flags": ["🏳️","🏴","🏁","🚩","🎌","🏴‍☠️","🇺🇳","🇦🇫","🇦🇱","🇩🇿","🇦🇩","🇦🇴","🇦🇬","🇦🇷","🇦🇲","🇦🇺","🇦🇹","🇦🇿","🇧🇸","🇧🇭","🇧🇩","🇧🇧","🇧🇾","🇧🇪","🇧🇿","🇧🇯","🇧🇹","🇧🇴","🇧🇦","🇧🇼","🇧🇷","🇧🇳","🇧🇬","🇧🇫","🇧🇮","🇰🇭","🇨🇲","🇨🇦","🇨🇻","🇨🇫","🇹🇩","🇨🇱","🇨🇳","🇨🇴","🇰🇲","🇨🇬","🇨🇩","🇨🇷","🇭🇷","🇨🇺","🇨🇾","🇨🇿","🇩🇰","🇩🇯","🇩🇲","🇩🇴","🇪🇨","🇪🇬","🇸🇻","🇬🇶","🇪🇷","🇪🇪","🇪🇹","🇫🇯","🇫🇮","🇫🇷","🇬🇦","🇬🇲","🇬🇪","🇩🇪","🇬🇭","🇬🇷","🇬🇩","🇬🇹","🇬🇳","🇬🇼","🇬🇾","🇭🇹","🇭🇳","🇭🇺","🇮🇸","🇮🇳","🇮🇩","🇮🇷","🇮🇶","🇮🇪","🇮🇱","🇮🇹","🇯🇲","🇯🇵","🇯🇴","🇰🇿","🇰🇪","🇰🇮","🇰🇵","🇰🇷","🇽🇰","🇰🇼","🇰🇬","🇱🇦","🇱🇻","🇱🇧","🇱🇸","🇱🇷","🇱🇾","🇱🇮","🇱🇹","🇱🇺","🇲🇬","🇲🇼","🇲🇾","🇲🇻","🇲🇱","🇲🇹","🇲🇭","🇲🇷","🇲🇺","🇲🇽","🇫🇲","🇲🇩","🇲🇨","🇲🇳","🇲🇪","🇲🇦","🇲🇿","🇲🇲","🇳🇦","🇳🇷","🇳🇵","🇳🇱","🇳🇿","🇳🇮","🇳🇪","🇳🇬","🇳🇴","🇴🇲","🇵🇰","🇵🇼","🇵🇸","🇵🇦","🇵🇬","🇵🇾","🇵🇪","🇵🇭","🇵🇱","🇵🇹","🇶🇦","🇷🇴","🇷🇺","🇷🇼","🇰🇳","🇱🇨","🇻🇨","🇼🇸","🇸🇲","🇸🇹","🇸🇦","🇸🇳","🇷🇸","🇸🇨","🇸🇱","🇸🇬","🇸🇰","🇸🇮","🇸🇧","🇸🇴","🇿🇦","🇸🇸","🇪🇸","🇱🇰","🇸🇩","🇸🇷","🇸🇪","🇨🇭","🇸🇾","🇹🇼","🇹🇯","🇹🇿","🇹🇭","🇹🇱","🇹🇬","🇹🇴","🇹🇹","🇹🇳","🇹🇷","🇹🇲","🇹🇻","🇺🇬","🇺🇦","🇦🇪","🇬🇧","🇺🇸","🇺🇾","🇺🇿","🇻🇺","🇻🇦","🇻🇪","🇻🇳","🇾🇪","🇿🇲","🇿🇼","🇦🇨","🇧🇻","🇨🇵","🇩🇬","🇪🇦","🇪🇺","🇫🇴","🇬🇱","🇭🇰","🇮🇨","🇮🇴","🇲🇴","🇲🇶","🇳🇨","🇵🇫","🇵🇲","🇷🇪","🇸🇭","🇸🇯","🇹🇦","🇹🇫","🇹🇰","🇻🇦","🇼🇫","🇾🇹"],
    "Animated": [
      { id: 'ae1', url: '/media/giphy/3o7TKSha7HbhXj6mRa.gif', name: 'Party 😄' },
      { id: 'ae2', url: '/media/giphy/l0HlNaQ6gWfllqwDO.gif', name: 'Dance 💃' },
      { id: 'ae3', url: '/media/giphy/3oEduQ2rYb6GtPOWk0.gif', name: 'Celebrate 🎉' },
      { id: 'ae4', url: '/media/giphy/26u4lOMA8BwodbbLG.gif', name: 'Love ❤️' },
      { id: 'ae5', url: '/media/giphy/3oEjI6SIIHBdRxXI40.gif', name: 'Wave 👋' },
      { id: 'ae6', url: '/media/giphy/3o85xGocYD8uV5K90U.gif', name: 'LOL 😂' },
      { id: 'ae7', url: '/media/giphy/26gs1dK2P7EzuXW2Y.gif', name: 'Cool 😎' },
      { id: 'ae8', url: '/media/giphy/3og0INyCmHlNylks9e.gif', name: 'OMG 😱' },
      { id: 'ae9', url: '/media/giphy/7MZ5eEl0MxQ2A.gif', name: 'Bye 👋' },
      { id: 'ae10', url: '/media/giphy/1nq5mP2nHlMGI.gif', name: 'Sleepy 😴' },
      { id: 'ae11', url: '/media/giphy/3o85xnoYEBk0b7vE4w.gif', name: 'Happy 😊' },
      { id: 'ae12', url: '/media/giphy/8t8jrF6YQbSqQ.gif', name: 'Clap 👏' },
      { id: 'ae13', url: '/media/giphy/3o6Zt481isNV1y7Aqk.gif', name: 'Mind Blown 🤯' },
      { id: 'ae14', url: '/media/giphy/26gJzVWvMMGMi0xHO.gif', name: 'Fire 🔥' },
      { id: 'ae15', url: '/media/giphy/jWcyMSGqMBhJG.gif', name: 'Love Sticker 💕' },
      { id: 'ae16', url: '/media/giphy/dSetNZ0M3OYq0.gif', name: 'Cute 🥰' },
      { id: 'ae17', url: '/media/giphy/l0HlUK7B2GMdKZKla.gif', name: 'Kiss 😘' },
      { id: 'ae18', url: '/media/giphy/3o7TKM6snABh6iIMvS.gif', name: 'Hug 🤗' },
      { id: 'ae19', url: '/media/giphy/3o7TKz5qWX8Pc6d6M0.gif', name: 'Happy Dance 🕺' },
      { id: 'ae20', url: '/media/giphy/13aJ2Im0F3XYqA.gif', name: 'Sad 😢' },
      { id: 'ae21', url: '/media/giphy/26FPo47jFGHLTNDMc.gif', name: 'Angry 😠' },
      { id: 'ae22', url: '/media/giphy/l0HlRuVN4l2dR8NBe.gif', name: 'Thumbs Up 👍' },
      { id: 'ae23', url: '/media/giphy/3o85xnxCcCjC1p6t6.gif', name: 'Party Time 🎉' },
      { id: 'ae24', url: '/media/giphy/3o7TKM6snABh6iIMvS.gif', name: 'Cuddle 🤗' },
      { id: 'ae25', url: '/media/giphy/l0HlNaQ6gWfllqwDO.gif', name: 'Dancing 💃' },
      { id: 'ae26', url: '/media/giphy/3o85xGocYD8uV5K90U.gif', name: 'ROFL 🤣' },
      { id: 'ae27', url: '/media/giphy/26gs1dK2P7EzuXW2Y.gif', name: 'Chill 😎' },
      { id: 'ae28', url: '/media/giphy/3og0INyCmHlNylks9e.gif', name: 'Shock 😲' },
      { id: 'ae29', url: '/media/giphy/7MZ5eEl0MxQ2A.gif', name: 'Goodbye 👋' },
      { id: 'ae30', url: '/media/giphy/1nq5mP2nHlMGI.gif', name: 'Tired 😴' },
      { id: 'ae31', url: '/media/giphy/l0HlUK7B2GMdKZKla.gif', name: 'Blowing Kiss 💋' },
      { id: 'ae32', url: '/media/giphy/3o7TKz5qWX8Pc6d6M0.gif', name: 'Jumping For Joy 🥳' },
      { id: 'ae33', url: '/media/giphy/3o7TKSha7HbhXj6mRa.gif', name: 'Let\'s Party 🎊' },
      { id: 'ae34', url: '/media/giphy/3oEduQ2rYb6GtPOWk0.gif', name: 'Confetti 🎉' },
      { id: 'ae35', url: '/media/giphy/8t8jrF6YQbSqQ.gif', name: 'Applause 👏' },
      { id: 'ae36', url: '/media/giphy/3o6Zt481isNV1y7Aqk.gif', name: 'Explosion 💥' },
      { id: 'ae37', url: '/media/giphy/26gJzVWvMMGMi0xHO.gif', name: 'On Fire 🔥' },
      { id: 'ae38', url: '/media/giphy/dSetNZ0M3OYq0.gif', name: 'Blush 😊' },
      { id: 'ae39', url: '/media/giphy/13aJ2Im0F3XYqA.gif', name: 'Crying 😭' },
      { id: 'ae40', url: '/media/giphy/26FPo47jFGHLTNDMc.gif', name: 'Fury 😤' },
      { id: 'ae41', url: '/media/giphy/jWcyMSGqMBhJG.gif', name: 'Heart Eyes 😍' },
      { id: 'ae42', url: '/media/giphy/3o85xnxCcCjC1p6t6.gif', name: 'Disco 🪩' },
      { id: 'ae43', url: '/media/giphy/3oEjI6SIIHBdRxXI40.gif', name: 'Hello Hi 👋' },
      { id: 'ae44', url: '/media/giphy/l0HlNaQ6gWfllqwDO.gif', name: 'Groove 🕺' },
      { id: 'ae45', url: '/media/giphy/1nq5mP2nHlMGI.gif', name: 'Sleep 😴' },
      { id: 'ae46', url: '/media/giphy/7MZ5eEl0MxQ2A.gif', name: 'Peace Out ✌️' },
      { id: 'ae47', url: '/media/giphy/l0HlRuVN4l2dR8NBe.gif', name: 'Like 👍' },
      { id: 'ae48', url: '/media/giphy/3o85xGocYD8uV5K90U.gif', name: 'Funny 😂' },
      { id: 'ae49', url: '/media/giphy/26gs1dK2P7EzuXW2Y.gif', name: 'Sunglasses 😎' },
      { id: 'ae50', url: '/media/giphy/3og0INyCmHlNylks9e.gif', name: 'Surprised 😮' },
      { id: 'ae51', url: '/media/giphy/3o6Zt481isNV1y7Aqk.gif', name: 'Boom 💥' },
      { id: 'ae52', url: '/media/giphy/26gJzVWvMMGMi0xHO.gif', name: 'Hot 🔥' },
      { id: 'ae53', url: '/media/giphy/jWcyMSGqMBhJG.gif', name: 'In Love 💘' },
      { id: 'ae54', url: '/media/giphy/dSetNZ0M3OYq0.gif', name: 'Kawaii 🥹' },
      { id: 'ae55', url: '/media/giphy/13aJ2Im0F3XYqA.gif', name: 'Heartbroken 💔' },
      { id: 'ae56', url: '/media/giphy/26FPo47jFGHLTNDMc.gif', name: 'Mad 😤' },
      { id: 'ae57', url: '/media/giphy/l0HlUK7B2GMdKZKla.gif', name: 'Smooch 💋' },
      { id: 'ae58', url: '/media/giphy/3o7TKM6snABh6iIMvS.gif', name: 'Embrace 🤗' },
      { id: 'ae59', url: '/media/giphy/3o7TKz5qWX8Pc6d6M0.gif', name: 'Woo Hoo 🥳' },
      { id: 'ae60', url: '/media/giphy/3o85xnxCcCjC1p6t6.gif', name: 'Celebrate Good Times 🎊' },
    ],
