...
io.on("connection", (socket) => {
  ...
  const EMOJI_DATA = {
    ...
    "Flags": ["🏳️","🏴","🏁","🚩","🎌","🏴‍☠️","🇺🇳","🇦🇫","🇦🇱","🇩🇿","🇦🇩","🇦🇴","🇦🇬","🇦🇷","🇦🇲","🇦🇺","🇦🇹","🇦🇿","🇧🇸","🇧🇭","🇧🇩","🇧🇧","🇧🇾","🇧🇪","🇧🇿","🇧🇯","🇧🇹","🇧🇴","🇧🇦","🇧🇼","🇧🇷","🇧🇳","🇧🇬","🇧🇫","🇧🇮","🇰🇭","🇨🇲","🇨🇦","🇨🇻","🇨🇫","🇹🇩","🇨🇱","🇨🇳","🇨🇴","🇰🇲","🇨🇬","🇨🇩","🇨🇷","🇭🇷","🇨🇺","🇨🇾","🇨🇿","🇩🇰","🇩🇯","🇩🇲","🇩🇴","🇪🇨","🇪🇬","🇸🇻","🇬🇶","🇪🇷","🇪🇪","🇪🇹","🇫🇯","🇫🇮","🇫🇷","🇬🇦","🇬🇲","🇬🇪","🇩🇪","🇬🇭","🇬🇷","🇬🇩","🇬🇹","🇬🇳","🇬🇼","🇬🇾","🇭🇹","🇭🇳","🇭🇺","🇮🇸","🇮🇳","🇮🇩","🇮🇷","🇮🇶","🇮🇪","🇮🇱","🇮🇹","🇯🇲","🇯🇵","🇯🇴","🇰🇿","🇰🇪","🇰🇮","🇰🇵","🇰🇷","🇽🇰","🇰🇼","🇰🇬","🇱🇦","🇱🇻","🇱🇧","🇱🇸","🇱🇷","🇱🇾","🇱🇮","🇱🇹","🇱🇺","🇲🇬","🇲🇼","🇲🇾","🇲🇻","🇲🇱","🇲🇹","🇲🇭","🇲🇷","🇲🇺","🇲🇽","🇫🇲","🇲🇩","🇲🇨","🇲🇳","🇲🇪","🇲🇦","🇲🇿","🇲🇲","🇳🇦","🇳🇷","🇳🇵","🇳🇱","🇳🇿","🇳🇮","🇳🇪","🇳🇬","🇳🇴","🇴🇲","🇵🇰","🇵🇼","🇵🇸","🇵🇦","🇵🇬","🇵🇾","🇵🇪","🇵🇭","🇵🇱","🇵🇹","🇶🇦","🇷🇴","🇷🇺","🇷🇼","🇰🇳","🇱🇨","🇻🇨","🇼🇸","🇸🇲","🇸🇹","🇸🇦","🇸🇳","🇷🇸","🇸🇨","🇸🇱","🇸🇬","🇸🇰","🇸🇮","🇸🇧","🇸🇴","🇿🇦","🇸🇸","🇪🇸","🇱🇰","🇸🇩","🇸🇷","🇸🇪","🇨🇭","🇸🇾","🇹🇼","🇹🇯","🇹🇿","🇹🇭","🇹🇱","🇹🇬","🇹🇴","🇹🇹","🇹🇳","🇹🇷","🇹🇲","🇹🇻","🇺🇬","🇺🇦","🇦🇪","🇬🇧","🇺🇸","🇺🇾","🇺🇿","🇻🇺","🇻🇦","🇻🇪","🇻🇳","🇾🇪","🇿🇲","🇿🇼","🇦🇨","🇧🇻","🇨🇵","🇩🇬","🇪🇦","🇪🇺","🇫🇴","🇬🇱","🇭🇰","🇮🇨","🇮🇴","🇲🇴","🇲🇶","🇳🇨","🇵🇫","🇵🇲","🇷🇪","🇸🇭","🇸🇯","🇹🇦","🇹🇫","🇹🇰","🇻🇦","🇼🇫","🇾🇹"],
    "Animated": [
      { id: 'ae1', url: 'https://media.giphy.com/media/3o7TKSha7HbhXj6mRa/giphy.gif', name: 'Party 😄' },
      { id: 'ae2', url: 'https://media.giphy.com/media/l0HlNaQ6gWfllqwDO/giphy.gif', name: 'Dance 💃' },
      { id: 'ae3', url: 'https://media.giphy.com/media/3oEduQ2rYb6GtPOWk0/giphy.gif', name: 'Celebrate 🎉' },
      { id: 'ae4', url: 'https://media.giphy.com/media/26u4lOMA8BwodbbLG/giphy.gif', name: 'Love ❤️' },
      { id: 'ae5', url: 'https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif', name: 'Wave 👋' },
      { id: 'ae6', url: 'https://media.giphy.com/media/3o85xGocYD8uV5K90U/giphy.gif', name: 'LOL 😂' },
      { id: 'ae7', url: 'https://media.giphy.com/media/26gs1dK2P7EzuXW2Y/giphy.gif', name: 'Cool 😎' },
      { id: 'ae8', url: 'https://media.giphy.com/media/3og0INyCmHlNylks9e/giphy.gif', name: 'OMG 😱' },
      { id: 'ae9', url: 'https://media.giphy.com/media/7MZ5eEl0MxQ2A/giphy.gif', name: 'Bye 👋' },
      { id: 'ae10', url: 'https://media.giphy.com/media/1nq5mP2nHlMGI/giphy.gif', name: 'Sleepy 😴' },
      { id: 'ae11', url: 'https://media.giphy.com/media/3o85xnoYEBk0b7vE4w/giphy.gif', name: 'Happy 😊' },
      { id: 'ae12', url: 'https://media.giphy.com/media/8t8jrF6YQbSqQ/giphy.gif', name: 'Clap 👏' },
      { id: 'ae13', url: 'https://media.giphy.com/media/3o6Zt481isNV1y7Aqk/giphy.gif', name: 'Mind Blown 🤯' },
      { id: 'ae14', url: 'https://media.giphy.com/media/26gJzVWvMMGMi0xHO/giphy.gif', name: 'Fire 🔥' },
      { id: 'ae15', url: 'https://media.giphy.com/media/jWcyMSGqMBhJG/giphy.gif', name: 'Love Sticker 💕' },
      { id: 'ae16', url: 'https://media.giphy.com/media/dSetNZ0M3OYq0/giphy.gif', name: 'Cute 🥰' },
      { id: 'ae17', url: 'https://media.giphy.com/media/l0HlUK7B2GMdKZKla/giphy.gif', name: 'Kiss 😘' },
      { id: 'ae18', url: 'https://media.giphy.com/media/3o7TKM6snABh6iIMvS/giphy.gif', name: 'Hug 🤗' },
      { id: 'ae19', url: 'https://media.giphy.com/media/3o7TKz5qWX8Pc6d6M0/giphy.gif', name: 'Happy Dance 🕺' },
      { id: 'ae20', url: 'https://media.giphy.com/media/13aJ2Im0F3XYqA/giphy.gif', name: 'Sad 😢' },
      { id: 'ae21', url: 'https://media.giphy.com/media/26FPo47jFGHLTNDMc/giphy.gif', name: 'Angry 😠' },
      { id: 'ae22', url: 'https://media.giphy.com/media/l0HlRuVN4l2dR8NBe/giphy.gif', name: 'Thumbs Up 👍' },
      { id: 'ae23', url: 'https://media.giphy.com/media/3o85xnxCcCjC1p6t6/giphy.gif', name: 'Party Time 🎉' },
      { id: 'ae24', url: 'https://media.giphy.com/media/3o7TKM6snABh6iIMvS/giphy.gif', name: 'Cuddle 🤗' },
      { id: 'ae25', url: 'https://media.giphy.com/media/l0HlNaQ6gWfllqwDO/giphy.gif', name: 'Dancing 💃' },
      { id: 'ae26', url: 'https://media.giphy.com/media/3o85xGocYD8uV5K90U/giphy.gif', name: 'ROFL 🤣' },
      { id: 'ae27', url: 'https://media.giphy.com/media/26gs1dK2P7EzuXW2Y/giphy.gif', name: 'Chill 😎' },
      { id: 'ae28', url: 'https://media.giphy.com/media/3og0INyCmHlNylks9e/giphy.gif', name: 'Shock 😲' },
      { id: 'ae29', url: 'https://media.giphy.com/media/7MZ5eEl0MxQ2A/giphy.gif', name: 'Goodbye 👋' },
      { id: 'ae30', url: 'https://media.giphy.com/media/1nq5mP2nHlMGI/giphy.gif', name: 'Tired 😴' },
      { id: 'ae31', url: 'https://media.giphy.com/media/l0HlUK7B2GMdKZKla/giphy.gif', name: 'Blowing Kiss 💋' },
      { id: 'ae32', url: 'https://media.giphy.com/media/3o7TKz5qWX8Pc6d6M0/giphy.gif', name: 'Jumping For Joy 🥳' },
      { id: 'ae33', url: 'https://media.giphy.com/media/3o7TKSha7HbhXj6mRa/giphy.gif', name: 'Let\'s Party 🎊' },
      { id: 'ae34', url: 'https://media.giphy.com/media/3oEduQ2rYb6GtPOWk0/giphy.gif', name: 'Confetti 🎉' },
      { id: 'ae35', url: 'https://media.giphy.com/media/8t8jrF6YQbSqQ/giphy.gif', name: 'Applause 👏' },
      { id: 'ae36', url: 'https://media.giphy.com/media/3o6Zt481isNV1y7Aqk/giphy.gif', name: 'Explosion 💥' },
      { id: 'ae37', url: 'https://media.giphy.com/media/26gJzVWvMMGMi0xHO/giphy.gif', name: 'On Fire 🔥' },
      { id: 'ae38', url: 'https://media.giphy.com/media/dSetNZ0M3OYq0/giphy.gif', name: 'Blush 😊' },
      { id: 'ae39', url: 'https://media.giphy.com/media/13aJ2Im0F3XYqA/giphy.gif', name: 'Crying 😭' },
      { id: 'ae40', url: 'https://media.giphy.com/media/26FPo47jFGHLTNDMc/giphy.gif', name: 'Fury 😤' },
      { id: 'ae41', url: 'https://media.giphy.com/media/jWcyMSGqMBhJG/giphy.gif', name: 'Heart Eyes 😍' },
      { id: 'ae42', url: 'https://media.giphy.com/media/3o85xnxCcCjC1p6t6/giphy.gif', name: 'Disco 🪩' },
      { id: 'ae43', url: 'https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif', name: 'Hello Hi 👋' },
      { id: 'ae44', url: 'https://media.giphy.com/media/l0HlNaQ6gWfllqwDO/giphy.gif', name: 'Groove 🕺' },
      { id: 'ae45', url: 'https://media.giphy.com/media/1nq5mP2nHlMGI/giphy.gif', name: 'Sleep 😴' },
      { id: 'ae46', url: 'https://media.giphy.com/media/7MZ5eEl0MxQ2A/giphy.gif', name: 'Peace Out ✌️' },
      { id: 'ae47', url: 'https://media.giphy.com/media/l0HlRuVN4l2dR8NBe/giphy.gif', name: 'Like 👍' },
      { id: 'ae48', url: 'https://media.giphy.com/media/3o85xGocYD8uV5K90U/giphy.gif', name: 'Funny 😂' },
      { id: 'ae49', url: 'https://media.giphy.com/media/26gs1dK2P7EzuXW2Y/giphy.gif', name: 'Sunglasses 😎' },
      { id: 'ae50', url: 'https://media.giphy.com/media/3og0INyCmHlNylks9e/giphy.gif', name: 'Surprised 😮' },
      { id: 'ae51', url: 'https://media.giphy.com/media/3o6Zt481isNV1y7Aqk/giphy.gif', name: 'Boom 💥' },
      { id: 'ae52', url: 'https://media.giphy.com/media/26gJzVWvMMGMi0xHO/giphy.gif', name: 'Hot 🔥' },
      { id: 'ae53', url: 'https://media.giphy.com/media/jWcyMSGqMBhJG/giphy.gif', name: 'In Love 💘' },
      { id: 'ae54', url: 'https://media.giphy.com/media/dSetNZ0M3OYq0/giphy.gif', name: 'Kawaii 🥹' },
      { id: 'ae55', url: 'https://media.giphy.com/media/13aJ2Im0F3XYqA/giphy.gif', name: 'Heartbroken 💔' },
      { id: 'ae56', url: 'https://media.giphy.com/media/26FPo47jFGHLTNDMc/giphy.gif', name: 'Mad 😤' },
      { id: 'ae57', url: 'https://media.giphy.com/media/l0HlUK7B2GMdKZKla/giphy.gif', name: 'Smooch 💋' },
      { id: 'ae58', url: 'https://media.giphy.com/media/3o7TKM6snABh6iIMvS/giphy.gif', name: 'Embrace 🤗' },
      { id: 'ae59', url: 'https://media.giphy.com/media/3o7TKz5qWX8Pc6d6M0/giphy.gif', name: 'Woo Hoo 🥳' },
      { id: 'ae60', url: 'https://media.giphy.com/media/3o85xnxCcCjC1p6t6/giphy.gif', name: 'Celebrate Good Times 🎊' },
    ],
  ...
  // ─── GIF & Sticker Library ────────────────────────────────────────
  const GIF_LIBRARY = [
    { id: 'g1', url: 'https://media.giphy.com/media/l0HlNaQ6gWfllqwDO/giphy.gif', name: 'Dancing' },
    { id: 'g2', url: 'https://media.giphy.com/media/3oEduQ2rYb6GtPOWk0/giphy.gif', name: 'Celebration' },
    { id: 'g3', url: 'https://media.giphy.com/media/26u4lOMA8BwodbbLG/giphy.gif', name: 'Love' },
    { id: 'g4', url: 'https://media.giphy.com/media/3o7TKSha7HbhXj6mRa/giphy.gif', name: 'Party' },
    { id: 'g5', url: 'https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif', name: 'Wave' },
    { id: 'g6', url: 'https://media.giphy.com/media/3o85xGocYD8uV5K90U/giphy.gif', name: 'LOL' },
    { id: 'g7', url: 'https://media.giphy.com/media/26gs1dK2P7EzuXW2Y/giphy.gif', name: 'Cool' },
    { id: 'g8', url: 'https://media.giphy.com/media/3og0INyCmHlNylks9e/giphy.gif', name: 'OMG' },
    { id: 'g9', url: 'https://media.giphy.com/media/7MZ5eEl0MxQ2A/giphy.gif', name: 'Bye' },
    { id: 'g10', url: 'https://media.giphy.com/media/1nq5mP2nHlMGI/giphy.gif', name: 'Sleepy' },
    { id: 'g11', url: 'https://media.giphy.com/media/3o85xnoYEBk0b7vE4w/giphy.gif', name: 'Happy Dance' },
    { id: 'g12', url: 'https://media.giphy.com/media/8t8jrF6YQbSqQ/giphy.gif', name: 'Clap' },
    { id: 'g13', url: 'https://media.giphy.com/media/3o6Zt481isNV1y7Aqk/giphy.gif', name: 'Sending Love' },
    { id: 'g14', url: 'https://media.giphy.com/media/3o6Zt481isNV1y7Aqk/giphy.gif', name: 'Mind Blown' },
    { id: 'g15', url: 'https://media.giphy.com/media/26gJzVWvMMGMi0xHO/giphy.gif', name: 'Fire' },
  ];

  // Sticker Library
  const STICKER_LIBRARY = [
    { id: 's1', url: 'https://media.giphy.com/media/jWcyMSGqMBhJG/giphy.gif', name: 'Love Sticker' },
    { id: 's2', url: 'https://media.giphy.com/media/dSetNZ0M3OYq0/giphy.gif', name: 'Cute' },
    { id: 's3', url: 'https://media.giphy.com/media/l0HlUK7B2GMdKZKla/giphy.gif', name: 'Kiss' },
    { id: 's4', url: 'https://media.giphy.com/media/3o7TKM6snABh6iIMvS/giphy.gif', name: 'Hug' },
    { id: 's5', url: 'https://media.giphy.com/media/3o7TKz5qWX8Pc6d6M0/giphy.gif', name: 'Happy' },
    { id: 's6', url: 'https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif', name: 'Wave' },
    { id: 's7', url: 'https://media.giphy.com/media/13aJ2Im0F3XYqA/giphy.gif', name: 'Sad' },
    { id: 's8', url: 'https://media.giphy.com/media/26FPo47jFGHLTNDMc/giphy.gif', name: 'Angry' },
    { id: 's9', url: 'https://media.giphy.com/media/l0HlRuVN4l2dR8NBe/giphy.gif', name: 'Thumbs Up' },
    { id: 's10', url: 'https://media.giphy.com/media/3o85xnxCcCjC1p6t6/giphy.gif', name: 'Party' },
    { id: 's11', url: 'https://media.giphy.com/media/3o6Zt6U0U0Y0Y0Y0Y0/giphy.gif', name: 'Love' },
    { id: 's12', url: 'https://media.giphy.com/media/3o7TKM6snABh6iIMvS/giphy.gif', name: 'Cuddle' },
  ];
